...
export const NoDomainsFound = () => {
  return (
    <div className="flex items-center justify-center">
      <div className="sm:items-start items-center sm:justify-start justify-center sm:w-1/2 w-full flex flex-col gap-5">
        <ProfileOverview />
        <span className="sm:text-start text-center  text-white font-azeret sm:px-0 px-3">
